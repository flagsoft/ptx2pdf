...
texpertOptions = {
    ...
    "IndentAtChapter":    O("chapindent", "BDY", False, None, _("Allow Indent Para with Cutouts"),
    ...
    "bookresetcallers":   O("bookresetcallers", "NTS", True, None, _("Reset Callers at Each Book"),
                            _("Re-start the footnote and cross-reference callers at the start of each book")),
    "notesEachBook":      O("neachbook", "NTS", True, None, _("Endnotes at Each Book"),
                            _("Output endnotes at the end of each book")),
    "newparnotes":        O("newparnotes", "NTS", False, None, _("Enhanced paragraphed footnotes"),
    ...
    "parnoteskillprevdepth": O("parntkillpd", "NTS", True, None, _("Remove depth above paragraphed notes"),
                               _("Kern away (kill) the glyph/font depth of note types before paragraphed notes, using the value of \\prevdepth")),
    "parnoteskilldepth":  O("parntkilldepth", "NTS", False, None, _("Remove depth after paragraphed notes"),
                            _("Kill the depth of (the last row of) paragraphed note styles. Paragraphed notes will use the margin as their baseline.")),
    "parnotesruletopskip": O("parntruletopskip", "NTS", False, None, _("Use grid not font/glyph height at rule"),
    ...
    "parnotesmidtopskip": O("parntmidtopskip", "NTS", True, None, _("Use grid not font/glyph height between notes"),
    ...
    "FootNoteGlyphMetrics": O("fnxugm", "NTS", False, None, _("Use glyph height not font height in footnotes"),
    ...
    "ShowVPchap":         O("showvpchap", "DIG", True, "", _("Show old chapter numbers if changed (in \\vp)"),
    ...
    "CaptionFirst":       O("captfirst", "PIC", False, None, _("Show Caption Before Image"),
    ...
    "Actions":            O("actions", "PDF", True, None, _("Allow Active Links in PDF"),
    ...
    "NoTransparency":     O("notransparent", "PDF", False, None, _("Disable Transparency in PDF"),
 ...
 # s_coverArtBleed
    ...
    "tildenbsp":          O("tildenbsp", "OTH", True, None, _("Tilde is No Break Space"),
